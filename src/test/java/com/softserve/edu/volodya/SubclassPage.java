...
public class SubclassPage extends ACommonComponent {
	...
	private static final String DESCRIPTION_PARAMETER_NAME = "parameters["
			+ ParameterCounter + "].description";
	private static final String UNIT_PARAMETER_NAME = "parameters["
			+ ParameterCounter + "].unitName";
	private static final String DISCRETE_PARAMETER_CSS = "#input"
			+ ParameterCounter + 1 + " #myparam2 [value='discreteParameters']";
	private static final String LINEAR_PARAMETER_CSS = "#input"
			+ ParameterCounter + 1 + " #myparam2 [value='linearParameters']";
	...
	public String FindSubclassName(String subclassName) {
		return driver.findElement(
				By.xpath(".//*[@id='datatable']//td[contains(.,'"
						+ subclassName + "')]")).getText();
	}
