...
public class Browsers {
    ...
    public void testFirefox4() throws Exception {
        ...
        //
        System.setProperty("webdriver.gecko.driver", "./lib/geckodriver0.15.0.exe"); // not
                                                                                     // working
                                                                                     // with
                                                                                     // firefox
                                                                                     // 53.0.3
    ...
    public void testInternetExplorer1() throws Exception {
        System.setProperty("webdriver.ie.driver", "./lib/IEDriverServer3.4.0-32.exe");
    ...
    public void testChrome2_1Certificate() throws Exception {
        ...
        // options.addArguments("--no-sandbox");
        // options.addArguments("--disable-web-security");
        options.addArguments("--ignore-certificate-errors"); // Work by
                                                             // default!!!
        // options.addArguments("--disable-extensions");
        WebDriver driver = new ChromeDriver(options);
        //
    ...
    public void testPhantomjs() throws Exception {
        System.setProperty("phantomjs.binary.path", "./lib/phantomjs2.1.1.exe");
    ...
    public void createService() throws Exception {
        service = new ChromeDriverService.Builder().usingDriverExecutable(new File("./lib/chromedriver.exe"))
                // .usingAnyFreePort()
