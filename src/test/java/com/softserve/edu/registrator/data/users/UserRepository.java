	...
	public IUser testActiveUserSearch() {
		return User.get()
				...
				.setPassport(Passport.get()
						.setSeria("ЛЛ")
						.setNumber("123456")
						.setPublished("7654321")
				);
	}
	public IUser testActiveUserSearchTableData() {
		return User.get()
				.setPerson(Person.get()
						.setFirstname("Ім'я")
						.setLastname("Прізвище")
						.setEmail("Електронна пошта")
						.build()
						.setMiddlename("")
						.setPhonenumber("")
				)
				.setAccount(Account.get()
						...
						.setRole("")
						.setStatus("")
						.setCommunity("Територіальна громада")
						.build()
						.setData("")
						.setRegisterNumber("")
						.setRegistratorNumber("")
