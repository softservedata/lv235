...
public class SmokeTest {
	...
	public void checkLogin(IUser user) throws Exception {
		// public void checkLogin(String login, String password) throws
		// Exception {
		//
		// Precondition
		//
		...
		System.out.println("Path to driver: "
				+ SmokeTest.class.getResource("/lib/chromedriver.exe")
						.getPath());
		System.setProperty("webdriver.chrome.driver", SmokeTest.class
		...
		Assert.assertEquals(commonPage.getLoginAccountText(), user.getAccount()
				.getLogin());
		//
