...
public class SettingsPageL10nTestUK {
	@Test
	public void userRegistrationOptionsComponentTestUK() {
		SettingsPage settingsPage = Application.get().load()
				.successAdminLogin(UserRepository.get().admin())
				.clickSettings();
		settingsPage.setChangeLanguage(ChangeLanguageFields.UKRAINIAN);
	...
	@Test
	public void defaultTimeZoneComponentTestUK() {
		SettingsPage settingsPage = Application.get().load()
				.successAdminLogin(UserRepository.get().admin())
				.clickSettings();
		settingsPage.setChangeLanguage(ChangeLanguageFields.UKRAINIAN);
	...
	@Test
	public void emailConfigurationComponentTestUK() {
		SettingsPage settingsPage = Application.get().load()
				.successAdminLogin(UserRepository.get().admin())
				.clickSettings();
		settingsPage.setChangeLanguage(ChangeLanguageFields.UKRAINIAN);
	...
	@Test
	public void settingsPageTestUK() {
		SettingsPage settingsPage = Application.get().load()
				.successAdminLogin(UserRepository.get().admin())
				.clickSettings();
		settingsPage.setChangeLanguage(ChangeLanguageFields.UKRAINIAN);
