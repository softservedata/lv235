...
public class SettingsPageL10nTestRU {

	@Test
	public void userRegistrationOptionsComponentTestRU() {
		SettingsPage settingsPage = Application.get().load()
				.successAdminLogin(UserRepository.get().admin())
				.clickSettings();
		settingsPage.setChangeLanguage(ChangeLanguageFields.RUSSIAN);
		...
		Assert.assertEquals(settingsPage.getUserRegistrationOptionsComponent()
				...
				UserRegistrationOptionsComponentL10n.COMPONENT_LABEL
						.getLocalization(ChangeLanguageFields.RUSSIAN));
		Assert.assertEquals(settingsPage.getUserRegistrationOptionsComponent()
				.getOptionLabelText(),
	...
	@Test
	public void defaultTimeZoneComponentTestRU() {
		SettingsPage settingsPage = Application.get().load()
				.successAdminLogin(UserRepository.get().admin())
				.clickSettings();
		settingsPage.setChangeLanguage(ChangeLanguageFields.RUSSIAN);
	...
	@Test
	public void emailConfigurationComponentTestRU() {
		SettingsPage settingsPage = Application.get().load()
				.successAdminLogin(UserRepository.get().admin())
				.clickSettings();
		settingsPage.setChangeLanguage(ChangeLanguageFields.RUSSIAN);
	...
	@Test
	public void settingsPageTestRU() {
		SettingsPage settingsPage = Application.get().load()
				.successAdminLogin(UserRepository.get().admin())
				.clickSettings();
		settingsPage.setChangeLanguage(ChangeLanguageFields.RUSSIAN);
